...
$(function () {
  $('.lifeup_pc').slick({
  	...
  	slidesToScroll: 1,
		arrows: true,
		prevArrow: '<img src="img/arrow_l.png" class="slick-arrow slick-prev">',
    nextArrow: '<img src="img/arrow_r.png" class="slick-arrow slick-next">',
		dots: false,
	});
	$('.lifeup_sp').slick({
		speed: 2000,
